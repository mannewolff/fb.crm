...
import type { Symbolname } from '../layout/navItems';
import { liesEingeklappt, merkeEingeklappt } from '../lib/railState';
import { CARD_RADIUS } from '../theme';
import BrandMark from './BrandMark';

/**
 * Die Schiene: eingelassene Nut links, oben die Marke, unten der Fuss (Vorlage `.schiene`
 * Z. 205–214, `.nav-eintrag` Z. 247–270, `.schiene-fuss` Z. 279).
 *
 * Zwischen Marke und Fuss steht in diesem Stand nichts (K11, E15). Der aktive Eintrag ist
 * die erhabene Taste mit kupfernem Symbol; `aria-current="page"` setzt `NavLink` selbst, und
 * genau daran haengt auch die Gestalt — Ansicht und Zugaenglichkeit koennen so nicht
 * auseinanderlaufen. Eingeklappt bleiben nur die Symbole; die Beschriftung geht in
 * `aria-label` ueber, damit jeder Eintrag seinen Namen behaelt.
 */
